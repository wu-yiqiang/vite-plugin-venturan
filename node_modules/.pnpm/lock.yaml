...
importers:
  ...
  .:
    dependencies:
      ...
      '@vitejs/plugin-vue':
        specifier: ^5.2.1
        version: 5.2.1(vite@6.2.0(@types/node@22.13.10))(vue@3.5.13)
      chalk:
        specifier: ^5.4.1
        version: 5.4.1
      compressing:
    ...
    devDependencies:
      ...
      vite:
        specifier: ^6.2.0
        version: 6.2.0(@types/node@22.13.10)
...
packages:
  ...
  compressing@1.10.1:
    resolution: {integrity: sha512-XXwUffcVjqv8NGSQu1ttp6eMmuZ3zZEAec28Rt30o/vkXE20jXhowRQ9LXLY4uOgFkxXrNzApLobpam53Dc1AA==}
    engines: {node: '>= 4.0.0'}
...
snapshots:
  ...
  '@vitejs/plugin-vue@5.2.1(vite@6.2.0(@types/node@22.13.10))(vue@3.5.13)':
    dependencies:
